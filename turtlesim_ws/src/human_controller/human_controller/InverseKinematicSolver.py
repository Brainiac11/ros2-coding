...
class InverseKinematicsSolver(Node):
    ...
    def solve_ik_callback(self, request, response):
        try:
            ...
            if fix_j1 and fix_j2 and fix_j3:
                ...
                result = self.solve_standard_3joint_ik_jacobian_transpose(
                    target_x, target_y, target_z,
                    l1, l2, l3
                )
    ...
    def solve_standard_3joint_ik_jacobian_transpose(self, x, y, z, l1, l2, l3) -> dict:
        # need to implement
        return {}
    ...
    def solve_with_j2_j3_fixed(self, x, y, z, l1, l2, l3, j2_fixed, j3_fixed):
        r_expected = l1 * math.cos(j2_fixed) + l2 * math.cos(j2_fixed) + l3 * math.cos(j2_fixed + j3_fixed)
        z_expected = l1 * math.sin(j2_fixed) + l2 * math.sin(j2_fixed) + l3 * math.sin(j2_fixed + j3_fixed)
