...
class HipController(Node):
    ...
    def _update_leg_positions(self) -> None:
        self._hip_roll_controller(self._increment(self._hip_roll, self._cmd_vel.linear.x))
        self._hip_yaw_pitch_controller(self._increment(self._hip_yaw_pitch, self._cmd_vel.linear.y))
        self._hip_pitch_controller(self._increment(self._hip_pitch, self._cmd_vel.linear.z))
