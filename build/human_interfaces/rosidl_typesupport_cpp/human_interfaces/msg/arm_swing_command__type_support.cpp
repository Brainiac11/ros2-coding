...
static const _ArmSwingCommand_type_support_symbol_names_t _ArmSwingCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, human_interfaces, msg, ArmSwingCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, human_interfaces, msg, ArmSwingCommand)),
  }
};
...
{
  return &::human_interfaces::msg::rosidl_typesupport_cpp::ArmSwingCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, human_interfaces, msg, ArmSwingCommand)() {
  return get_message_type_support_handle<human_interfaces::msg::ArmSwingCommand>();
}
