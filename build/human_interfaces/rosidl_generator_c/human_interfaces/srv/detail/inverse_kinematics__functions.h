...
#ifndef HUMAN_INTERFACES__SRV__DETAIL__INVERSE_KINEMATICS__FUNCTIONS_H_
#define HUMAN_INTERFACES__SRV__DETAIL__INVERSE_KINEMATICS__FUNCTIONS_H_
 ...
 * )) before or use
 * human_interfaces__srv__InverseKinematics_Request__create()
 ...
 * calls
 * human_interfaces__srv__InverseKinematics_Request__init().
...
/**
 * It calls
 * human_interfaces__srv__InverseKinematics_Request__fini()
...
/**
 * It calls
 * human_interfaces__srv__InverseKinematics_Request__Sequence__fini()
 * on the array,
 ...
 * )) before or use
 * human_interfaces__srv__InverseKinematics_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_human_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * human_interfaces__srv__InverseKinematics_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_human_interfaces
...
/**
 * It calls
 * human_interfaces__srv__InverseKinematics_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_human_interfaces
...
/**
 * It calls
 * human_interfaces__srv__InverseKinematics_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * human_interfaces__srv__InverseKinematics_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_human_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * human_interfaces__srv__InverseKinematics_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_human_interfaces
...
/**
 * It calls
 * human_interfaces__srv__InverseKinematics_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_human_interfaces
...
/**
 * It allocates the memory for the array and calls
 * human_interfaces__srv__InverseKinematics_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_human_interfaces
...
/**
 * It calls
 * human_interfaces__srv__InverseKinematics_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // HUMAN_INTERFACES__SRV__DETAIL__INVERSE_KINEMATICS__FUNCTIONS_H_
